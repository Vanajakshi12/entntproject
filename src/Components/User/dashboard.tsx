...
const companies: Company[] = [
  ...
  },
  {
    ...
    nextScheduledCommunication: { type: "Survey", date: "2028-01-07" },
  },
  {
    Id: 10,
    name: "RetailTech",
...
function isDateCrossed(givenDate, format = "MM/DD/YYYY") {
  ...
  const parsedDate = moment(givenDate, format,true);
  const parsedDates = new Date(givenDate);
